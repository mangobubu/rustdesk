...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "MG远程协助"),
        ("desk_tip", "复制下面的 ID 和密码然后发送给远程协助者"),
        ("Password", "密码"),
        ("Ready", "连接成功"),
        ("Established", "已建立"),
        ("connecting_status", "正在连接MG网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制, 请给予 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问, 请给予 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 使用\"无障碍\"服务。"),
        ...
        ("still_click_uac_tip", "需要被控端用户在 UAC 窗口点击确认。"),
        ...
        ("Strong", "强"),
        ("Switch Sides", "反转访问方向"),
        ("Please confirm if you want to share your desktop?", "请确认是否要让对方进行远程协助？"),
        ("Display", "显示"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果陌生人要求你使用本工具进行远程协助，请勿继续操作并立刻断开连接。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当窗口打开时允许连接"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在被控端将客户端升级至版本 {} 或更新版本！"),
        ("view_camera_unsupported_tip", "被控端不支持查看摄像头。"),
